...
var Module = typeof WasmReact !== 'undefined' ? WasmReact : {};
...
var wasmBinaryFile = '/react-wasm.wasm';
...
// {{PRE_LIBRARY}}
  ...
  var _stderr=5296;var FS={root:null,mounts:[],devices:{},streams:[],nextInode:1,nameTable:null,currentPath:"/",initialized:false,ignorePermissions:true,trackingDelegate:{},tracking:{openFlags:{READ:1,WRITE:2}},ErrnoError:null,genericErrors:{},filesystems:null,syncFSRequests:0,handleFSError:function (e) {
...
var _emscripten_alloc_async_context = Module["_emscripten_alloc_async_context"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_emscripten_alloc_async_context"].apply(null, arguments) };
var _emscripten_async_resume = Module["_emscripten_async_resume"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_emscripten_async_resume"].apply(null, arguments) };
var _emscripten_free_async_context = Module["_emscripten_free_async_context"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_emscripten_free_async_context"].apply(null, arguments) };
var _emscripten_realloc_async_context = Module["_emscripten_realloc_async_context"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_emscripten_realloc_async_context"].apply(null, arguments) };
...
var setAsync = Module["setAsync"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["setAsync"].apply(null, arguments) };
...
if (typeof exports === 'object' && typeof module === 'object')
      module.exports = WasmReact;
    else if (typeof define === 'function' && define['amd'])
      define([], function() { return WasmReact; });
    else if (typeof exports === 'object')
      exports["WasmReact"] = WasmReact;
